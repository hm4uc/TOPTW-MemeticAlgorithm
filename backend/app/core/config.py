...
POPULATION_SIZE: int = 150    # Kích thước quần thể
HEURISTIC_COUNT: int = 120    # 80% → Randomized Insertion Heuristic
RANDOM_COUNT:    int = 30     # 20% → Pure Random
